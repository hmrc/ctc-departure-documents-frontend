...
class GoodsItemNumberControllerSpec extends SpecBase with AppWithDefaultMockFixtures {
  ...
  private lazy val goodsItemNumberRoute = routes.GoodsItemNumberController.onPageLoad(lrn, mode).url
  ...
  "GoodsItemNumber Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(GoodsItemNumberPage, "test string")
