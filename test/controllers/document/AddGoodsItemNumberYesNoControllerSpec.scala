...
class AddGoodsItemNumberYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {
  ...
  private lazy val addGoodsItemNumberYesNoRoute = routes.AddGoodsItemNumberYesNoController.onPageLoad(lrn, mode, documentIndex).url
  ...
  "AddGoodsItemNumberYesNo Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(AddGoodsItemNumberYesNoPage(documentIndex), true)
